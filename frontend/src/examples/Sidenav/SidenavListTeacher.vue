<template>
  ...
  >
    <ul class="navbar-nav">
      <li class="nav-item">
        <sidenav-collapse navText="ประกาศ" :to="{ name: 'Publish' }">
          <template #icon>
            <shop />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="สถานประกอบการณ์" :to="{ name: 'Oganization' }">
          <template #icon>
            <office />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="เอกสารที่เกี่ยวข้อง" :to="{ name: 'Documents' }">
          <template #icon>
            <credit-card />
          </template>
        </sidenav-collapse>
  ...
  <div class="pt-3 mx-3 mt-3 sidenav-footer">
    ...
    <sidenav-card
      :class="cardBg"
      textPrimary="MY KU"
      textSecondary="ดูวิชาที่ลงทะเบียนเรียน"
      route="https://my.ku.th/login"
      label="see more"
      icon="ni ni-diamond"
    />
  </div>
